...
enum LinoTheme {
    ...
    static let bg = page
    static let bg2 = hairline
    static let surface = Color.white.opacity(0.68)
    static let surface2 = Color.white.opacity(0.54)
    static let ink2 = body
    static let line = hairline
    static let line2 = stroke
    static let accentText = Color.white
    static let amber = warning
    static let coverInk = Color.white
    ...
    static func coverPaper(_ seed: String) -> Color { hex(0x5B8DEF) }
...
enum LinoType {
    ...
    #else
    static let display = ui(30, .bold)
    static let heading = ui(20, .bold)
    static let paneTitle = heading
    static let bookTitle = ui(17, .semibold)
    static let cardTitle = ui(17, .semibold)
    static let rowTitle = ui(15, .semibold)
    static let editorTitle = ui(25, .bold)
    static let bodyText = serif(15)
    static let reading = serif(19)
